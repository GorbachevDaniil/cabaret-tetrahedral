...
TEST(createCellCenterNode, Positive) {
    ...
    EXPECT_EQ(5, mesh.nodes.size());
    EXPECT_EQ(3, mesh.nodes[0].coords.size());
    EXPECT_EQ(3, mesh.nodes[1].coords.size());
    EXPECT_EQ(3, mesh.nodes[2].coords.size());
    EXPECT_EQ(3, mesh.nodes[3].coords.size());
    EXPECT_EQ(3, mesh.nodes[4].coords.size());

    EXPECT_EQ(4, mesh.nodes[4].ID);
    EXPECT_DOUBLE_EQ(0.25, mesh.nodes[4].coords[0]);
    EXPECT_DOUBLE_EQ(0.25, mesh.nodes[4].coords[1]);
    EXPECT_DOUBLE_EQ(0.25, mesh.nodes[4].coords[2]);
...
TEST(createFaceInnerNodes, Positive) {
    ...
    EXPECT_EQ(6, mesh.nodes.size());
    EXPECT_EQ(3, mesh.nodes[0].coords.size());
    EXPECT_EQ(3, mesh.nodes[1].coords.size());
    EXPECT_EQ(3, mesh.nodes[2].coords.size());
    EXPECT_EQ(3, mesh.nodes[3].coords.size());
    EXPECT_EQ(3, mesh.nodes[4].coords.size());
    EXPECT_EQ(3, mesh.nodes[5].coords.size());

    EXPECT_EQ(3, mesh.nodes[3].ID);
    EXPECT_DOUBLE_EQ(1, mesh.nodes[3].coords[0]);
    EXPECT_DOUBLE_EQ(1, mesh.nodes[3].coords[1]);
    EXPECT_DOUBLE_EQ(0, mesh.nodes[3].coords[2]);

    EXPECT_EQ(4, mesh.nodes[4].ID);
    EXPECT_DOUBLE_EQ(2, mesh.nodes[4].coords[0]);
    EXPECT_DOUBLE_EQ(1, mesh.nodes[4].coords[1]);
    EXPECT_DOUBLE_EQ(0, mesh.nodes[4].coords[2]);

    EXPECT_EQ(5, mesh.nodes[5].ID);
    EXPECT_DOUBLE_EQ(1, mesh.nodes[5].coords[0]);
    EXPECT_DOUBLE_EQ(2, mesh.nodes[5].coords[1]);
    EXPECT_DOUBLE_EQ(0, mesh.nodes[5].coords[2]);
...
TEST(fillNodeNodeRelation, Positive) {
    ...
    EXPECT_EQ(12, mesh.cells[0].nodeIDToOppositeNodeID.size());
